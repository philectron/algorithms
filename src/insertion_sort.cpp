...
int main() {
    std::ifstream fin("../input/insertion_sort.in");
    std::ofstream fou("../output/insertion_sort.ou");
    ...
    fou << "Performing insertion sort on arrays" << std::endl << std::endl;
    for (int t = 1; t <= num_test_cases / 2; t++) {
        ...
        algorithm::InsertionSort<int>(array, n);
    ...
    fou << "Performing insertion sort on std::vectors\n\n";
    for (int t = num_test_cases / 2 + 1; t <= num_test_cases; t++) {
        ...
        algorithm::InsertionSort<int>(array);
