...
int main() {
    ...
    fou << "Performing merge sort on arrays" << std::endl << std::endl;
    for (int t = 1; t <= num_test_cases / 2; t++) {
        ...
        algorithm::MergeSort<int>(array, n);
    ...
    fou << "Performing merge sort on std::vectors" << std::endl << std::endl;
