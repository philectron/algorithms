...
public class SortUtilsTest {
    ...
    @Test
    void swap_sameIndices_doesNothing() {
    ...
    @Test
    void swap_differentIndices_switchesElements() {
    ...
    @Test
    void swap_nCopiesArray_retainsSameArray() {
